...
<c:forEach var="vo" items='${memberList}'>
	<p>
	<a href='${pageContext.request.contextPath}/member/edit.do?memId=<c:out value="${vo.memId}"/>' style="text-decoration:none"><c:out value="${vo.memId}"/></a>:
	<c:out value="${vo.memName}"/>:
	${vo.memPoint}
	<a href='${pageContext.request.contextPath}/member/del.do?memId=<c:out value="${vo.memId}"/>'><button type='button'>삭제[x]</button></a>	
